...
The other bit of magic I've devoted time to is the episode notes markup. WYSIWYG editors are wonderful if you're creating a whole new web page. For recurring tasks, though, they're slow and bulky. Instead, let's take a little time to learn a markup language and let the computer do the formatting for us. In this case, I've created the most minimal of markup languages. Assuming you'll usually have the same topic headers every show, we define those in the config file, and automatically format them as headers. Here's a cheatsheet for the markup:

| Feature                   | Description                                                                                                                                                                                                    | Example                                                                                                               | Result                                                                                                                                                  |
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| URL at end of line        | Assumed to be sources or links to additional information, these are displayed as shortened links. I've tried to make this as powerful as possible, please let me know if there's formatting you'd like to see. | Here's a statement I've made. http://here-is.more-information.com/but_you_usually_dont_need/to_see/the_whole_URL_path | Here's a statement I've made. ([here-is.more-information.com](http://here-is.more-information.com/but_you_usually_dont_need/to_see/the_whole_URL_path)) |
| URL with parens (at EOL)  | You can wrap the URL in parens if you like, and you can include padding inside the parens as well. Note that URLs are recognized with or without the protocol.                                                 | Here's a statement I've made. (heres-more-information.com/but_you_usually_dont_need/to_see/the_whole_URL_path)        | Here's a statement I've made. ([heres-more-information.com](heres-more-information.com/but_you_usually_dont_need/to_see/the_whole_URL_path))            |
| Twitter URL (at EOL)      | Links to Tweets retain the username.                                                                                                                                                                           | https://twitter.com/orbitalpodcast/status/1217250112088440836                                                         | ([twitter.com/orbitalpodcast](https://twitter.com/orbitalpodcast/status/1217250112088440836))                                                           |
| Reddit URL (at EOL        | Links to Reddit posts are displayed in a very shortened way.                                                                                                                                                   | https://www.reddit.com/r/orbitalpodcast/comments/e90r63/episode_239_downlinkkyla_edison/                              | ([/r/orbitalpodcast](https://www.reddit.com/r/orbitalpodcast/comments/e90r63/episode_239_downlinkkyla_edison/))                                         |
| Link to PDF (at EOL)      | PDFs are great sources, but can clobber cell phones. We need to warn the user.                                                                                                                                 | https://www.big_file.com/hope_youre_ready.pdf                                                                         | (PDF: [big_file.com](https://www.big_file.com/hope_youre_ready.pdf))                                                                                    |
| URL with hat tip (at EOL) | Sometimes your source needs a source! Hat tips are not meant to be URLs, and are passed through as plain text. Just add HT <content>: before your URL.                                                         | Here's a source I never would have found on my own. HT Sam in the chat: linkity.link/such_a_long_URL                  | Here's a source I never would have found on my own. (HT Sam in the chat: [linkity.link](linkity.link/such_a_long_URL))                                  |
| Escaped URL (at EOL)      | Sometimes you might want the whole link! Escape it with three backslashes, with or without padding spaces.                                                                                                     | \\\\\ thislink.com/wants-extra-info                                                                                   | ([thislink.com/wants-extra-info](thislink.com/wants-extra-info))                                                                                        |
|                           |                                                                                                                                                                                                                |                                                                                                                       |                                                                                                                                                         |
