  ...
  xml.channel do
    ...
    @episodes.each do |episode|
      xml.item do
        ...
        xml.guid episode_url(episode) # TODO: implement GUID override for episodes still on the Squarespace feed at publish time. Include isPermaLink="false" when overriding
